...
/* ./.libs/lt-pic2plot.c - temporary wrapper executable for .libs/pic2plot.exe
   Generated by libtool (GNU libtool) 2.4.2

   The pic2plot program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "pic2plot.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# pic2plot - temporary wrapper script for .libs/pic2plot.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2\n", f);
  fputs ("#\n", f);
  fputs ("# The pic2plot program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"pic2plot.exe:pic2plot:${LINENO}: libtool wrapper (GNU libtool) 2.4.2\"", f);
  fputs (" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"pic2plot.exe:pic2plot:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"pic2plot.exe:pic2plot:${LINENO}: newargv[0]: $progdir/$program\" ", f);
  fputs ("1>&2\n", f);
