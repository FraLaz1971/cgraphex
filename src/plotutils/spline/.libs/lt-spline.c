...
/* ./.libs/lt-spline.c - temporary wrapper executable for .libs/spline.exe
   Generated by libtool (GNU libtool) 2.4.2

   The spline program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "spline.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# spline - temporary wrapper script for .libs/spline.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2\n", f);
  fputs ("#\n", f);
  fputs ("# The spline program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"spline.exe:spline:${LINENO}: libtool wrapper (GNU libtool) 2.4.2\" 1>&", f);
  fputs ("2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"spline.exe:spline:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"spline.exe:spline:${LINENO}: newargv[0]: $progdir/$program\" 1>&2\n", f);
