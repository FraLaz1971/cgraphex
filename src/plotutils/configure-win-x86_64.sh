...
CPPFLAGS="-DDEBUG=1 -DPNG_PTR=1 -DINCLUDE_PNG_SUPPORT  -DHAVE_LIBPNG=1  -I/mingw64/include -I$LIBPNGROOT/include/ -I$LIBPNGROOT/include/libpng16  -Iinclude -DMINGW=1 -DGNUC=1 " \
