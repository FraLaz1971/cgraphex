...
CPPFLAGS="-DDEBUG=1 -DPNG_PTR=1 -DINCLUDE_PNG_SUPPORT  -DHAVE_LIBPNG=1  -I/mingw32/include -I$LIBPNGROOT/include/ -I$LIBPNGROOT/include/libpng16 -Iinclude -DMINGW=1 -DGNUC=1 " \
...
LDFLAGS="-L$LIBPNGROOT/lib -L../libplot/.libs -lplot -lm -lpng"
