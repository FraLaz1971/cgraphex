...
/* ./.libs/lt-ode.c - temporary wrapper executable for .libs/ode.exe
   Generated by libtool (GNU libtool) 2.4.2

   The ode program cannot be directly executed until all the libtool
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# ode - temporary wrapper script for .libs/ode.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2\n", f);
  fputs ("#\n", f);
  fputs ("# The ode program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"ode.exe:ode:${LINENO}: libtool wrapper (GNU libtool) 2.4.2\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"ode.exe:ode:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"ode.exe:ode:${LINENO}: newargv[0]: $progdir/$program\" 1>&2\n", f);
