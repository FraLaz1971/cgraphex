...
/* ./.libs/lt-tek2plot.c - temporary wrapper executable for .libs/tek2plot.exe
   Generated by libtool (GNU libtool) 2.4.2

   The tek2plot program cannot be directly executed until all the libtool
...
const char * EXE_PATH_VALUE   = "C:\\msys32\\home\\serena\\projects\\cgraphex\\src\\libpng\\lib;C:\\msys32\\home\\serena\\projects\\cgraphex\\src\\libpng\\bin;C:\\msys32\\home\\serena\\projects\\cgraphex\\src\\plotutils\\libplot\\.libs;C:\\msys32\\home\\serena\\projects\\cgraphex\\src\\libpng\\lib;C:\\msys32\\home\\serena\\projects\\cgraphex\\src\\libpng\\bin;";
const char * TARGET_PROGRAM_NAME = "tek2plot.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# tek2plot - temporary wrapper script for .libs/tek2plot.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2\n", f);
  fputs ("#\n", f);
  fputs ("# The tek2plot program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"tek2plot.exe:tek2plot:${LINENO}: libtool wrapper (GNU libtool) 2.4.2\"", f);
  fputs (" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"tek2plot.exe:tek2plot:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"tek2plot.exe:tek2plot:${LINENO}: newargv[0]: $progdir/$program\" ", f);
  fputs ("1>&2\n", f);
  ...
  fputs ("src/plotutils/libplot/.libs:/home/serena/projects/cgraphex/src/libpng-1.6.37/..", f);
  fputs ("/libpng/lib:/home/serena/projects/cgraphex/src/libpng-1.6.37/../libpng/bin:$PAT", f);
  fputs ("H\n", f);
  fputs ("\n", f);
