...
/* ./.libs/lt-graph.c - temporary wrapper executable for .libs/graph.exe
   Generated by libtool (GNU libtool) 2.4.6 Debian-2.4.6-2

   The graph program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "graph.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# graph - temporary wrapper script for .libs/graph.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6 Debian-2.4.6-2\n", f);
  fputs ("#\n", f);
  fputs ("# The graph program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"graph.exe:graph:$LINENO: libtool wrapper (GNU libtool) 2.4.6 Debian-2", f);
  fputs (".4.6-2\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"graph.exe:graph:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"graph.exe:graph:$LINENO: newargv[0]: $progdir/$program\" 1>&2\n", f);
