...
/* ./.libs/lt-plot.c - temporary wrapper executable for .libs/plot.exe
   Generated by libtool (GNU libtool) 2.4.2

   The plot program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "plot.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# plot - temporary wrapper script for .libs/plot.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2\n", f);
  fputs ("#\n", f);
  fputs ("# The plot program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"plot.exe:plot:${LINENO}: libtool wrapper (GNU libtool) 2.4.2\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"plot.exe:plot:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"plot.exe:plot:${LINENO}: newargv[0]: $progdir/$program\" 1>&2\n", f);
