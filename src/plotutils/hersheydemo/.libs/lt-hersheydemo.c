...
/* ./.libs/lt-hersheydemo.c - temporary wrapper executable for .libs/hersheydemo.exe
   Generated by libtool (GNU libtool) 2.4.6 Debian-2.4.6-2

   The hersheydemo program cannot be directly executed until all the libtool
...
const char * LIB_PATH_VALUE   = "C;/msys32/mingw32/lib;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "/mingw32/bin;/mingw32/lib;C;/msys32/mingw32/lib;C;/msys32/mingw32/bin;";
const char * TARGET_PROGRAM_NAME = "hersheydemo.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# hersheydemo - temporary wrapper script for .libs/hersheydemo.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6 Debian-2.4.6-2\n", f);
  fputs ("#\n", f);
  fputs ("# The hersheydemo program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("  notinst_deplibs=' C:/msys32/mingw32/lib/libpng.la C:/msys32/mingw32/lib/libpn", f);
  fputs ("g16.la /mingw32/lib/libpng16.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"hersheydemo.exe:hersheydemo:$LINENO: libtool wrapper (GNU libtool) 2.", f);
  fputs ("4.6 Debian-2.4.6-2\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"hersheydemo.exe:hersheydemo:$LINENO: newargv[$lt_dump_args_N]: $lt_a", f);
  fputs ("rg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"hersheydemo.exe:hersheydemo:$LINENO: newargv[0]: $progdir/$progr", f);
  fputs ("am\" 1>&2\n", f);
  ...
  fputs ("    PATH=/mingw32/bin:/mingw32/lib:C:/msys32/mingw32/lib:C:/msys32/mingw32/bin:", f);
  fputs ("$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"C:/msys32/mingw32/lib:$PATH\"\n", f);
  fputs ("\n", f);
