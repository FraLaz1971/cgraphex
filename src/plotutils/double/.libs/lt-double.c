...
/* ./.libs/lt-double.c - temporary wrapper executable for .libs/double.exe
   Generated by libtool (GNU libtool) 2.4.6 Debian-2.4.6-2

   The double program cannot be directly executed until all the libtool
...
const char * LIB_PATH_VALUE   = "/mingw32/lib;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "/mingw32/bin;/mingw32/lib;";
const char * TARGET_PROGRAM_NAME = "double.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# double - temporary wrapper script for .libs/double.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6 Debian-2.4.6-2\n", f);
  fputs ("#\n", f);
  fputs ("# The double program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("  notinst_deplibs=' /mingw32/lib/libpng16.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"double.exe:double:$LINENO: libtool wrapper (GNU libtool) 2.4.6 Debian", f);
  fputs ("-2.4.6-2\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"double.exe:double:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"double.exe:double:$LINENO: newargv[0]: $progdir/$program\" 1>&2\n", f);
  ...
  fputs ("    PATH=/mingw32/bin:/mingw32/lib:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/mingw32/lib:$PATH\"\n", f);
  fputs ("\n", f);
