...
/* ./.libs/lt-plotfont.c - temporary wrapper executable for .libs/plotfont.exe
   Generated by libtool (GNU libtool) 2.4.2

   The plotfont program cannot be directly executed until all the libtool
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# plotfont - temporary wrapper script for .libs/plotfont.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2\n", f);
  fputs ("#\n", f);
  fputs ("# The plotfont program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"plotfont.exe:plotfont:${LINENO}: libtool wrapper (GNU libtool) 2.4.2\"", f);
  fputs (" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"plotfont.exe:plotfont:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"plotfont.exe:plotfont:${LINENO}: newargv[0]: $progdir/$program\" ", f);
  fputs ("1>&2\n", f);
