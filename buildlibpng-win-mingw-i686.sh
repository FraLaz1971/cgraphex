...
/mingw32/bin/i686-w64-mingw32-gcc-ar rcs libz.a adler32.o compress.o crc32.o deflate.o gzclose.o gzlib.o gzread.o gzwrite.o infback.o inffast.o inflate.o inftrees.o trees.o uncompr.o zutil.o 2>&1 | tee ar_zlib_$(date --iso).log
